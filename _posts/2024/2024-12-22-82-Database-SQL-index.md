...
The leftmost rule của multi-column index: key ngoài cùng bên trái phải ưu tiên toán tử = trong câu query, vì nó giúp giới hạn index range scan. Cụ thể hơn, đọc [2a] 
...
### 7. Partial results: Limit and seeking approach 
Link:
- [7a] - https://use-the-index-luke.com/sql/partial-results/fetch-next-page
